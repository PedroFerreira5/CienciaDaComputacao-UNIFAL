...
int main() {
    ...
    cout << "\n1 - Inverter valores";
    cout << "\n2 - Adicionar valor a todos os elementos";
    cout << "\n3 - Adicionar valor aos que não são divisíveis por 3";
    cout << "\n4 - Remover uma ocorrência de um valor";
    cout << "\n5 - Remover todas as ocorrências de um valor";
    cout << "\n6 - Inserir um valor no vetor se ele não estiver cheio";
    cout << "\n7 - Inserir um valor em uma posição determinada";
    cout << "\n8 - Remover todos os valores repetidos de um vetor";
    cout << "\n0 - Sair";
    cout << "\nOpção: ";
    cin >> opcao;
